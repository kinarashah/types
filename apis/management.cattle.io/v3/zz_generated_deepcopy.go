...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MultiClusterAppUpgradeInput) DeepCopyInto(out *MultiClusterAppUpgradeInput) {
	*out = *in
	if in.Answers != nil {
		in, out := &in.Answers, &out.Answers
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MultiClusterAppUpgradeInput.
func (in *MultiClusterAppUpgradeInput) DeepCopy() *MultiClusterAppUpgradeInput {
	if in == nil {
		return nil
	}
	out := new(MultiClusterAppUpgradeInput)
	in.DeepCopyInto(out)
	return out
}
